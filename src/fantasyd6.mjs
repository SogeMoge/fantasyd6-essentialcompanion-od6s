// import { ESTIMATE_STATES_EN, ESTIMATE_STATES_RU } from "./healthestimatevars";
...
Hooks.on("init", () => {
  ...
  game.settings.register(MOD_NAME, "autoRegisterBabel", {
  ...
  if (game.settings.get(MOD_NAME, "autoRegisterBabel")) {
    autoRegisterBabel();
  }
});
...
class ConfigureOpenD6Options extends FormApplication {
  ...
  getData(options) {
    ...
    return {
      ...
      options: [
        {
          id: "labels",
          on: state.labels ?? true,
          desc: "fantasyd6.form.labels",
        },
        {
          id: "fields",
          on: state.fields ?? true,
          desc: "fantasyd6.form.fields",
        },
        {
          id: "deadly",
          on: state.deadly ?? true,
          desc: "fantasyd6.form.deadly",
        },
  ...
  activateListeners(html) {
    html.find("button.cancel").on("click", (e) => {
      e.preventDefault();
      this.close();
    });
    html.find("button.submit").on("click", (e) => {
      e.preventDefault();
      this.submit();
    });
  }
  ...
  async updateLabels() {
    await game.settings.set(
      "od6s",
      "customize_fate_points",
      game.i18n.localize("fantasyd6.customize_fate_points"),
    );
    await game.settings.set(
      "od6s",
      "customize_fate_points_short",
      game.i18n.localize("fantasyd6.customize_fate_points_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_currency_label",
      game.i18n.localize("fantasyd6.customize_currency_label"),
    );
    await game.settings.set(
      "od6s",
      "customize_vehicle_toughness",
      game.i18n.localize("fantasyd6.customize_vehicle_toughness"),
    );
    await game.settings.set(
      "od6s",
      "customize_starship_toughness",
      game.i18n.localize("fantasyd6.customize_starship_toughness"),
    );
    await game.settings.set(
      "od6s",
      "interstellar_drive_name",
      game.i18n.localize("fantasyd6.interstellar_drive_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_extranormal",
      game.i18n.localize("fantasyd6.customize_metaphysics_extranormal"),
    );
    await game.settings.set(
      "od6s",
      "customize_manifestations",
      game.i18n.localize("fantasyd6.customize_manifestations"),
    );
    await game.settings.set(
      "od6s",
      "customize_manifestation",
      game.i18n.localize("fantasyd6.customize_manifestation"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_name_short",
      game.i18n.localize("fantasyd6.customize_metaphysics_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_name",
      game.i18n.localize("fantasyd6.customize_metaphysics_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_skill_channel",
      game.i18n.localize("fantasyd6.customize_metaphysics_skill_channel"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_skill_sense",
      game.i18n.localize("fantasyd6.customize_metaphysics_skill_sense"),
    );
    await game.settings.set(
      "od6s",
      "customize_metaphysics_skill_transform",
      game.i18n.localize("fantasyd6.customize_metaphysics_skill_transform"),
    );
    await game.settings.set(
      "od6s",
      "customize_agility_name",
      game.i18n.localize("fantasyd6.customize_agility_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_agility_name_short",
      game.i18n.localize("fantasyd6.customize_agility_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_strength_name",
      game.i18n.localize("fantasyd6.customize_strength_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_strength_name_short",
      game.i18n.localize("fantasyd6.customize_strength_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_mechanical_name",
      game.i18n.localize("fantasyd6.customize_mechanical_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_mechanical_name_short",
      game.i18n.localize("fantasyd6.customize_mechanical_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_knowledge_name",
      game.i18n.localize("fantasyd6.customize_knowledge_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_knowledge_name_short",
      game.i18n.localize("fantasyd6.customize_knowledge_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_perception_name",
      game.i18n.localize("fantasyd6.customize_perception_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_perception_name_short",
      game.i18n.localize("fantasyd6.customize_perception_name_short"),
    );
    await game.settings.set(
      "od6s",
      "customize_technical_name",
      game.i18n.localize("fantasyd6.customize_technical_name"),
    );
    await game.settings.set(
      "od6s",
      "customize_technical_name_short",
      game.i18n.localize("fantasyd6.customize_technical_name_short"),
    );
  }
  ...
  async updateFields() {
    await game.settings.set(
      "od6s",
      "custom_field_1",
      game.i18n.localize("fantasyd6.custom_field_1"),
    );
    await game.settings.set(
      "od6s",
      "custom_field_1_short",
      game.i18n.localize("fantasyd6.custom_field_1_short"),
    );
    await game.settings.set(
      "od6s",
      "custom_field_1_type",
      game.i18n.localize("fantasyd6.custom_field_1_type"),
    );
    await game.settings.set("od6s", "custom_field_1_actor_types", 3);
    await game.settings.set(
      "od6s",
      "custom_field_2",
      game.i18n.localize("fantasyd6.custom_field_2"),
    );
    await game.settings.set(
      "od6s",
      "custom_field_2_short",
      game.i18n.localize("fantasyd6.custom_field_2_short"),
    );
    await game.settings.set(
      "od6s",
      "custom_field_2_type",
      game.i18n.localize("fantasyd6.custom_field_2_type"),
    );
  ...
  async updateDeadly() {
    ...
    await game.settings.set("healthEstimate", "core.estimations", [
      {
        "name": "Character",
        "ignoreColor": false,
        "rule": "default",
        "estimates": [
          {
            ...
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.0",
            ),
          },
          {
            "value": 1,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.1",
            ),
          },
          {
            "value": 25,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.25",
            ),
          },
          {
            "value": 50,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.50",
            ),
          },
          {
            "value": 75,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.75",
            ),
          },
          {
            "value": 99,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.99",
            ),
          },
          {
            "value": 100,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.default.100",
            ),
          },
        ],
      },
        ...
        "estimates": [
          {
            "value": 0,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.0",
            ),
          },
          {
            "value": 20,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.20",
            ),
          },
          {
            "value": 40,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.40",
            ),
          },
          {
            "value": 60,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.60",
            ),
          },
          {
            "value": 80,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.80",
            ),
          },
          {
            "value": 100,
            "label": game.i18n.localize(
              "healthEstimate.core.estimations.vehichle.100",
            ),
          },
        ],
      },
  ...
  async updateRules() {
    ...
    await game.settings.set(
      "od6s",
      "brawl_attribute",
      game.i18n.localize("fantasyd6.brawl_attribute"),
    );
